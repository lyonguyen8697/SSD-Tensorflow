...
from datasets import mani_to_tfrecords, mani_unlabeled_to_tfrecords
...
def main(_):
    ...
    elif FLAGS.dataset_name == 'mani':
        mani_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name)
    elif FLAGS.dataset_name == 'mani_unlabeled':
        mani_unlabeled_to_tfrecords.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name)
    else:
